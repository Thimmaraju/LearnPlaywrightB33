  ...
  - group "iFrame Example" [ref=e174]:
    ...
    - iframe [ref=e176]:
      - generic [ref=f9e2]:
        - banner [ref=f9e3]:
              ...
              - list [ref=f9e12]:
                ...
                - listitem [ref=f9e16]:
                  - link "" [ref=f9e17] [cursor=pointer]:
                    ...
                    - generic [ref=f9e18]: 
              - link " Register" [ref=f9e20] [cursor=pointer]:
                - /url: https://courses.rahulshettyacademy.com/sign_up
                - generic [ref=f9e21]: 
                - text: Register
              - link " Login" [ref=f9e23] [cursor=pointer]:
          ...
          - generic [ref=f9e27]:
            - link [ref=f9e30] [cursor=pointer]:
              - /url: /
            - navigation [ref=f9e32]:
              - list [ref=f9e34]:
                - listitem [ref=f9e35]:
                  - link "Home" [ref=f9e36] [cursor=pointer]:
                    - /url: /
                - listitem [ref=f9e37]:
                  - link "Courses" [ref=f9e38] [cursor=pointer]:
                    - /url: https://courses.rahulshettyacademy.com/courses
                - listitem [ref=f9e39]:
                  - link "NEW All Access plan" [ref=f9e40] [cursor=pointer]:
                    - /url: lifetime-access
                - listitem [ref=f9e41]:
                  - link "NEW Learning paths" [ref=f9e42] [cursor=pointer]:
                    - /url: learning-path
                - listitem [ref=f9e43]:
                  - link "Mentorship" [ref=f9e44] [cursor=pointer]:
                    - /url: mentorship
                - listitem [ref=f9e45]:
                  - link "Job Support" [ref=f9e46] [cursor=pointer]:
                    - /url: consulting
                - listitem [ref=f9e47]:
                  - link "Practice" [ref=f9e48] [cursor=pointer]:
                    - /url: practice-project
                - listitem [ref=f9e49]:
                  - link "Blog" [ref=f9e50] [cursor=pointer]:
                    - /url: https://rahulshettyacademy.com/blog/
                - listitem [ref=f9e51]:
                  - link "More " [ref=f9e52] [cursor=pointer]:
                    - /url: "#"
                    - text: More
                    - generic [ref=f9e53]: 
                  - text: 
        - generic [ref=f9e54]:
          - generic [ref=f9e59]:
            - img "First slide" [ref=f9e60]
            - generic [ref=f9e62]:
              - heading "An Academy to Learn Earn & Shine in your QA Career" [level=2] [ref=f9e63]:
                - generic [ref=f9e64]:
                  - text: An Academy to
                  - strong [ref=f9e65]: Learn Earn & Shine
                  - text: in your QA Career
              - heading "World-class tutorials on Selenium, Rest Assured, Cypress, Appium, Postman, Cucumber, SoapUI, Playwright, Jmeter, Jira, and many more. Join our courses now to get the best job opportunity." [level=3] [ref=f9e66]
              - link "JOIN NOW" [ref=f9e68] [cursor=pointer]:
                - /url: https://courses.rahulshettyacademy.com/sign_up
          - generic [ref=f9e72]:
            - generic [ref=f9e74]:
              - generic [ref=f9e76]: 
              - generic [ref=f9e77]: 600,000 +
              - heading "Students" [level=4] [ref=f9e78]
            - generic [ref=f9e80]:
              - generic [ref=f9e82]: 
              - generic [ref=f9e83]: 30 +
              - heading "Courses" [level=4] [ref=f9e84]
            - generic [ref=f9e86]:
              - generic [ref=f9e88]: 
              - generic [ref=f9e89]: 257,000 +
              - heading "Ratings" [level=4] [ref=f9e90]
            - generic [ref=f9e92]:
              - generic [ref=f9e94]: 
              - generic [ref=f9e95]: 30 +
              - heading "Projects" [level=4] [ref=f9e96]
          - generic [ref=f9e99]:
            - heading "why we are Leaders in market?!" [level=2] [ref=f9e100]
            - generic [ref=f9e101]:
              - list [ref=f9e103]:
                - listitem [ref=f9e104]: The academy is led by Rahul Shetty, a Test evangelist and Test architect with over 10+ years in the IT industry.
                - listitem [ref=f9e105]: Rahul Shetty is a pioneer and authority in software testing space.
                - listitem [ref=f9e106]: He has taught over 300,000 students in 195 countries from across the world.
                - listitem [ref=f9e107]: All our courses are based on Real Time Project based where you learn real skill which are readily transferable to your work project.
                - listitem [ref=f9e108]: Our courses are guaranteed to help you reach your career goals and develop your automation skills
                - listitem [ref=f9e109]: Life time access, Learn at your own pace and updates are Free for Life.
              - list [ref=f9e111]:
                - listitem [ref=f9e112]: Wide coverage of topics like Selenium, Appium, Cucumber BDD, Cypress, Protractor, RestAPI, SoapUI and JMeter etc.
                - listitem [ref=f9e113]: His mentorship program is most after in the software testing community with long waiting period.
                - listitem [ref=f9e114]: Once under his mentorship, you are preparing yourself for long term success with his expert guidance and support.
                - listitem [ref=f9e115]: Lot of companies have already benefited from our consulting services.
                - listitem [ref=f9e116]: We are essentially a Full Stack QA consulting and Training company and we got you covered for your test implementation and training needs.
          - generic [ref=f9e118]:
            - generic [ref=f9e119]:
              - heading "Our Students" [level=2] [ref=f9e120]
              - generic [ref=f9e121]:
            ...
            - generic [ref=f9e122]:
              - generic [ref=f9e124]:
                ...
                - generic [ref=f9e154]:
                  - text: 
                  - heading "Gruffydd Dickerson" [level=4] [ref=f9e155]
                  - generic [ref=f9e156]: Student of software testing
                  - generic [ref=f9e157]: Guys,I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field,but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f9e158]:
                    - generic [ref=f9e159]: 
                    - generic [ref=f9e160]: 
                    - generic [ref=f9e161]: 
                ...
                - generic [ref=f9e167]:
                  - text: 
                  - heading "Jesse Shepard" [level=4] [ref=f9e168]
                  - generic [ref=f9e169]: student of selenium
                  - generic [ref=f9e170]: I am so glad I found the right course and the right instructor. The instructor is too good..knowledgeable and supportive. I always get replies on my queries within hours and that helps me become productive.And this shows the dedication of the instructor as well. Very commendable and exceptional and elaborate teaching.Studying this course has increased my confidence.
                  - generic [ref=f9e171]:
                    - generic [ref=f9e172]: 
                    - generic [ref=f9e173]: 
                    - generic [ref=f9e174]: 
                ...
                - generic [ref=f9e180]:
                  - text: 
                  - heading "Zubair Rowley" [level=4] [ref=f9e181]
                  - generic [ref=f9e182]: Student of software testing
                  - generic [ref=f9e183]: Guys, I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field, but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f9e184]:
                    - generic [ref=f9e185]: 
                    - generic [ref=f9e186]: 
                    - generic [ref=f9e187]: 
                ...
                - generic [ref=f9e193]:
                  - text: 
                  - heading "Sania Wynn" [level=4] [ref=f9e194]
                  - generic [ref=f9e195]: student of selenium
                ...
                - generic [ref=f9e206]:
                  - text: 
                  - heading "Gruffydd Dickerson" [level=4] [ref=f9e207]
                  - generic [ref=f9e208]: Student of software testing
                  - generic [ref=f9e209]: Guys,I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field,but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f9e210]:
                    - generic [ref=f9e211]: 
                    - generic [ref=f9e212]: 
                    - generic [ref=f9e213]: 
                ...
                - generic [ref=f9e219]:
                  - text: 
                  - heading "Jesse Shepard" [level=4] [ref=f9e220]
                  - generic [ref=f9e221]: student of selenium
                  - generic [ref=f9e222]: I am so glad I found the right course and the right instructor. The instructor is too good..knowledgeable and supportive. I always get replies on my queries within hours and that helps me become productive.And this shows the dedication of the instructor as well. Very commendable and exceptional and elaborate teaching.Studying this course has increased my confidence.
                  - generic [ref=f9e223]:
                    - generic [ref=f9e224]: 
                    - generic [ref=f9e225]: 
                    - generic [ref=f9e226]: 
          ...
          - generic [ref=f9e229]:
            - generic [ref=f9e231]:
              - heading "Featured Courses" [level=2] [ref=f9e233]
              - generic [ref=f9e236] [cursor=pointer]:
                - generic: Dollar($) Rupee(₹)
            - link "VIEW ALL COURSES" [ref=f9e239] [cursor=pointer]:
              - /url: https://courses.rahulshettyacademy.com/courses
        - generic [ref=f9e242]:
          - generic [ref=f9e243]:
            - heading "JOIN OUR ACADEMY" [level=2] [ref=f9e244]
            - generic [ref=f9e245]: Sign up today and get access to "Core Java for Testers" & "QA Resume Preparation" Courses for FREE.
          - link "JOIN NOW" [ref=f9e248] [cursor=pointer]:
            - /url: https://courses.rahulshettyacademy.com/sign_up
        - contentinfo [ref=f9e249]:
          - generic [ref=f9e252]:
            - generic [ref=f9e254]:
              - text: All Right Reserved
              - link "RahulShettyAcademy" [ref=f9e255] [cursor=pointer]:
                - /url: "#"
              - text: © 2026
            - list [ref=f9e257]:
              - listitem [ref=f9e258]:
                - link "About Us" [ref=f9e259] [cursor=pointer]:
                  - /url: /about-my-mission
              - listitem [ref=f9e260]:
                - link "Contact Us" [ref=f9e261] [cursor=pointer]:
                  - /url: contact-us
              - listitem [ref=f9e262]:
                - link "Privacy Policy" [ref=f9e263] [cursor=pointer]:
                  - /url: /privacy
        - text: 
  - table [ref=e178]:
    - rowgroup [ref=e179]:
