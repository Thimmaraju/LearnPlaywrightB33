...
test('Cehck box example 2', async ({ page }) => {
    ...
    const checkboxes = ['//input[@value="2"]', '//input[@value="6"]', '//input[@value="9"]','//input[@value="9"]']
...
test('Cehck box example 3', async ({ page }) => {
        ...
        const checkboxes = await page.$$('//input[@type="checkbox"]') // [locator1, locator2, locator3, locator4]
...
// page.$(locator) - it will return first matching 

// page.$$(locator)- it will returnm array

//================================================

// driver.findElement(locator) - it will return first matching 

// driver.findElements(locator) - array